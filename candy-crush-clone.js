(function (root, factory) {
    if (typeof define === 'function' && define.amd)
        ...
        if (typeof kotlin === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['korio-root-korio'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'korio-root-korio' was not found. Please, check whether 'korio-root-korio' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['korim-root-korim'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'korim-root-korim' was not found. Please, check whether 'korim-root-korim' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['korge-root-korge'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'korge-root-korge' was not found. Please, check whether 'korge-root-korge' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['klock-root-klock'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'klock-root-klock' was not found. Please, check whether 'klock-root-klock' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['korma-root-korma'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'korma-root-korma' was not found. Please, check whether 'korma-root-korma' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['klogger-root-klogger'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'klogger-root-klogger' was not found. Please, check whether 'klogger-root-klogger' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['korgw-root-korgw'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'korgw-root-korgw' was not found. Please, check whether 'korgw-root-korgw' is loaded prior to 'candy-crush-clone'.");
        }
        if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
            throw new Error("Error loading module 'candy-crush-clone'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'candy-crush-clone'.");
        }
        root['candy-crush-clone'] = factory(typeof this['candy-crush-clone'] === 'undefined' ? {} : this['candy-crush-clone'], kotlin, this['korio-root-korio'], this['korim-root-korim'], this['korge-root-korge'], this['klock-root-klock'], this['korma-root-korma'], this['klogger-root-klogger'], this['korgw-root-korgw'], this['kotlinx-coroutines-core']);
    }
    ...
    function GameFlow$swapTiles$lambda(it) {
        return Tile$Companion_getInstance().randomTile();
    }

    function GameFlow$swapTiles$lambda_0(this$GameFlow, closure$connectedTiles, closure$nextMoves, closure$newTileMoves) {
        return function (it) {
            ...
            this$GameFlow.animator_0.animateInsert_cklanf$(closure$newTileMoves);
            return Unit;
        };
    }
    ...
    GameFlow.prototype.swapTiles_0 = function (posA, posB) {
        ...
        var newTileMoves = this.mechanics_0.getNewTileMoves_93tlaa$(GameFlow$swapTiles$lambda);
        this.animator_0.animateSwap_th10u$(posA, posB).invokeOnCompletion_f05bi3$(GameFlow$swapTiles$lambda_0(this, connectedTiles, nextMoves, newTileMoves));
    };
    GameFlow.$metadata$ = {
        kind: Kind_CLASS,
        simpleName: 'GameFlow',
    ...
    GameMechanics.prototype.getConnectedTiles_oav4bx$ = function (pos) {
        var vertical = this.getVerticalConnected_oav4bx$(pos);
        var horizontal = this.getHorizontalConnected_oav4bx$(pos);
        if (horizontal.size >= 3 && vertical.size >= 3) {
            return plus(vertical, horizontal);
    ...
    GameMechanics.prototype.isHorizontalConnected_oav4bx$ = function (pos) {
        return this.getHorizontalSurroundings_oav4bx$(pos).size >= 3;
    };
    GameMechanics.prototype.getHorizontalConnected_oav4bx$ = function (pos) {
        return this.getHorizontalSurroundings_oav4bx$(pos);
    };
    GameMechanics.prototype.getVerticalConnected_oav4bx$ = function (pos) {
        return this.getVerticalSurroundings_oav4bx$(pos);
    };
    ...
    GameMechanics.prototype.isVerticalConnected_oav4bx$ = function (pos) {
        return this.getVerticalSurroundings_oav4bx$(pos).size >= 3;
    };
    ...
    GameMechanics.prototype.move_ame2ec$ = function (moves) {
        var tmp$;
        tmp$ = moves.iterator();
        while (tmp$.hasNext()) {
            var element = tmp$.next();
            this.move_v2epn7$(element);
        }
    };
    ...
    function Tile$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant j4k.candycrush.model.Tile.' + name);
        }
    }
    ...
    TileAnimator.prototype.animateInsert_cklanf$ = function (moves) {
        ...
        var tmp$_1;
        tmp$_1 = moveByColumn.keys.iterator();
        while (tmp$_1.hasNext()) {
            var element_0 = tmp$_1.next();
            var tmp$_2;
            var columnMoves = (tmp$_2 = moveByColumn.get_11rb$(element_0)) != null ? sorted(tmp$_2) : null;
            if (columnMoves != null) {
                var tmp$_3, tmp$_0_0;
                var index = 0;
                tmp$_3 = columnMoves.iterator();
                while (tmp$_3.hasNext()) {
                    var item = tmp$_3.next();
                    this.animateInsert_14fc59$(item, Kotlin.Long.fromInt((1 + checkIndexOverflow((tmp$_0_0 = index, index = tmp$_0_0 + 1 | 0, tmp$_0_0)) | 0) * 500 | 0));
                }
            }
        }
    };
    ...
    function Coroutine$TileAnimator$animateInsert$lambda$lambda(closure$image_0, $receiver_0, controller, continuation_0) {
        CoroutineImpl.call(this, continuation_0);
        this.$controller = controller;
        this.exceptionState_0 = 1;
        this.local$closure$image = closure$image_0;
    ...
    Coroutine$TileAnimator$animateInsert$lambda$lambda.$metadata$ = {
        kind: Kotlin.Kind.CLASS,
        simpleName: null,
        interfaces: [CoroutineImpl]
    };
    Coroutine$TileAnimator$animateInsert$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
    Coroutine$TileAnimator$animateInsert$lambda$lambda.prototype.constructor = Coroutine$TileAnimator$animateInsert$lambda$lambda;
    Coroutine$TileAnimator$animateInsert$lambda$lambda.prototype.doResume = function () {
        do
            try {
                switch (this.state_0) {
                    case 0:
    ...
    function TileAnimator$animateInsert$lambda$lambda(closure$image_0) {
        return function ($receiver_0, continuation_0, suspended) {
            var instance = new Coroutine$TileAnimator$animateInsert$lambda$lambda(closure$image_0, $receiver_0, this, continuation_0);
            if (suspended)
                return instance;
            else
                return instance.doResume(null);
    ...
    function Coroutine$TileAnimator$animateInsert$lambda(closure$delay_0, closure$image_0, closure$target_0, closure$move_0, this$TileAnimator_0, $receiver_0, controller, continuation_0) {
        CoroutineImpl.call(this, continuation_0);
        this.$controller = controller;
        this.exceptionState_0 = 1;
            ...
            try {
                switch (this.state_0) {
                    ...
                    case 1:
                        throw this.exception_0;
                    case 2:
                        launch(this.local$$receiver, void 0, void 0, TileAnimator$animateInsert$lambda$lambda(this.local$closure$image));
                        this.state_0 = 3;
                        this.result_0 = this.local$this$TileAnimator.move_1(this.local$closure$image, this.local$closure$target, this.local$this$TileAnimator.fallingAnimation_0(this.local$closure$move.target.row), this);
                        if (this.result_0 === COROUTINE_SUSPENDED)
                            return COROUTINE_SUSPENDED;
                        continue;
                    case 3:
    ...
    function TileAnimator$animateInsert$lambda(closure$delay_0, closure$image_0, closure$target_0, closure$move_0, this$TileAnimator_0) {
        return function ($receiver_0, continuation_0, suspended) {
            var instance = new Coroutine$TileAnimator$animateInsert$lambda(closure$delay_0, closure$image_0, closure$target_0, closure$move_0, this$TileAnimator_0, $receiver_0, this, continuation_0);
            if (suspended)
                return instance;
            else
                return instance.doResume(null);
    ...
    TileAnimator.prototype.animateInsert_14fc59$ = function (move, delay) {
        var image = this.renderer_0.addTile_tts3q9$(move.target, move.tile);
        image.alpha = 0.0;
        var target = this.getImagePoint_rzfvfi$(move.target);
        var start = this.getImagePoint_rzfvfi$(move.target.moveToStart());
        var x = start.x;
        var y = start.y;
        image.x = numberToDouble(x);
        image.y = numberToDouble(y);
        this.addJob_dqr1mp$(launch(this.view, void 0, void 0, TileAnimator$animateInsert$lambda(delay, image, target, move, this)));
    };
    ...
    Kotlin.defineModule('candy-crush-clone', _);
    return _;
}));

//# sourceMappingURL=candy-crush-clone.js.map
