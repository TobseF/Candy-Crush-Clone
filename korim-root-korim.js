(function (root, factory) {
    ...
    function BitmapChannel$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.bitmap.BitmapChannel.' + name);
        }
    }
    ...
    function decode($receiver, data, dataOffset, out, outOffset, size, littleEndian) {
        ...
        switch ($receiver.bpp) {
            ...
            case 32:
                ...
                break;
            default:
                throw IllegalArgumentException_init('Unsupported bpp ' + $receiver.bpp);
        }
        var readFunc = tmp$;
        var tmp$_0;
        var io = dataOffset;
    ...
    RGBA$Companion.prototype.mix_jh0t86$ = function (dst, src) {
        ...
        switch (srcA) {
            ...
            case 255:
                ...
                break;
            default:
                tmp$ = RGBA$Companion_getInstance().invoke_vux9f0$(this.mixRgbFactor256_74wf1k$(dst, src, srcA + 1 | 0).rgb, clamp0_255(srcA + (Kotlin.imul(dst.a, iSrcA) / 255 | 0) | 0));
                break;
        }
        return tmp$;
    };
    ...
    function TtfFont$NameIds$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.font.ttf.TtfFont.NameIds.' + name);
        }
    }
    ...
    function TtfFont$Origin$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.font.ttf.TtfFont.Origin.' + name);
        }
    }
    ...
    BMP.prototype.readImage_1ooaqm$$default = function (s, props) {
        ...
        switch (h.bitsPerPixel) {
            ...
            case 32:
                ...
                break;
            default:
                throw new NotImplementedError_init('An operation is not implemented: ' + ('Unsupported bitsPerPixel=' + h.bitsPerPixel));
        }
        return tmp$_2;
    };
        ...
        return function (e, s) {
            ...
            switch (bitCount) {
                ...
                case 32:
                    ...
                    break;
                default:
                    throw UnsupportedOperationException_init('Unsupported bitCount: ' + bitCount);
            }
            return tmp$;
        };
    }
    ...
    function PNG$Colorspace$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.format.PNG.Colorspace.' + name);
        }
    }
    ...
    function Context2d$LineCap$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.LineCap.' + name);
        }
    }
    ...
    function Context2d$LineJoin$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.LineJoin.' + name);
        }
    }
    ...
    function Context2d$CycleMethod$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.CycleMethod.' + name);
        }
    }
    ...
    function Context2d$ShapeRasterizerMethod$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.ShapeRasterizerMethod.' + name);
        }
    }
    ...
    function Context2d$VerticalAlign$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.VerticalAlign.' + name);
        }
    }
    ...
    function Context2d$HorizontalAlign$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.HorizontalAlign.' + name);
        }
    }
    ...
    function Context2d$ScaleMode$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.ScaleMode.' + name);
        }
    }
    ...
    function Context2d$Gradient$Kind$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.Gradient.Kind.' + name);
        }
    }
    ...
    function Context2d$Gradient$Units$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.Gradient.Units.' + name);
        }
    }
    ...
    function Context2d$Gradient$InterpolationMethod$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.Context2d.Gradient.InterpolationMethod.' + name);
        }
    }
        ...
        block$break: do {
            switch ($receiver.getType().name) {
                ...
                case 'SCALE_TRANSLATE':
                    ...
                    break block$break;
                default:
                    block$result = 'matrix(' + get_niceStr($receiver.a) + ', ' + get_niceStr($receiver.b) + ', ' + get_niceStr($receiver.c) + ', ' + get_niceStr($receiver.d) + ', ' + get_niceStr($receiver.tx) + ', ' + get_niceStr($receiver.ty) + ')';
                    break block$break;
            }
        }
        while (false);
    ...
    TextShape.prototype.buildSvg_b7xfbk$ = function (svg) {
        ...
        switch (this.halign.name) {
            ...
            case 'RIGHT':
                ...
                break;
            default:
                tmp$_10 = Kotlin.noWhenBranchMatched();
                break;
        }
    ...
    function ChartBars$Fit$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.chart.ChartBars.Fit.' + name);
        }
    }
    ...
    function SVG$GradientUnits$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.korim.vector.format.SVG.GradientUnits.' + name);
        }
    }
