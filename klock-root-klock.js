(function (root, factory) {
    ...
    function DateTime$Companion$DatePart$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.klock.DateTime.Companion.DatePart.' + name);
        }
    }
    ...
    function DayOfWeek$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.klock.DayOfWeek.' + name);
        }
    }
    ...
    function Month$valueOf(name) {
        switch (name) {
            ...
            default:
                throwISE('No enum constant com.soywiz.klock.Month.' + name);
        }
    }
